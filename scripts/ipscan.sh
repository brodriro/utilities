...
then
    echo "theHarvester could not be found, pleaase install it or use Kali-Linux" | $writeToFile
else
    theHarvester -d $domain -b baidu,dnsdumpster,subdomaincenter,yahoo,urlscan,sitedossier,rapiddns,duckduckgo,github-code -l 100 | $writeToFile
fi 
echo "=========================================" | $writeToFile
echo " " | $writeToFile
